      ...
      child: ListTile(
        ...
        title: Container(
          ...
          child: Column(
            ...
            children: [
              Text(pickup.picking_date.toString(),style:TextStyle(fontWeight: FontWeight.bold,color:Colors.white )),
              Text(pickup.pick_number,style:TextStyle(fontWeight: FontWeight.bold,color:Colors.white )),
          ...
          child: Column(
            ...
            children: [
              ...
              Text(pickup.warehouse_phone.toString()),
               Text(pickup.pick_momo.toString()),
