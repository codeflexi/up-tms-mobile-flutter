...
class LoadDataModel {
  ...
  final String load_number;
  final String load_momo;
  final String loading_date;
  ...
  LoadDataModel({
    ...
    required this.load_number,
    required this.load_momo,
    required this.loading_date,
...
//   }
  ...
  factory LoadDataModel.fromJson(Map<String, dynamic> json) {
    //  if (json == null) {
    //   return;
    // }
