...
import 'package:flutter_ws_1/src/features/direct/screens/direct_detail.dart';
...
class DirectHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final shipment =
        ModalRoute.of(context)!.settings.arguments as ShipmentsDataModel;
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(
            ...
            elevation: 0,
            title: const Text("รับของจากคลังต้นทาง"),
            leading: IconButton(
                onPressed: () {
               ...
               Expanded(
                child: TabBarView(
                  children: [
                    ...
                    //2nd Tab
                    DirectDetailPage(shipmentId: shipment.shipment_id,),
